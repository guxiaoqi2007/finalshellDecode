 ...
 * <p>
 *
 * @author eric.yu 2023/4/14
 * @since 4.3.x1500
 */
public class FinalShellPwdDecode {
    public static void main(String[] args) throws Exception {
        ArrayList<String> pathFiles = getPathFiles("C:\\Users\\hello world\\AppData\\Local\\finalshell\\conn\\");
        ArrayList<String> passwords = new ArrayList<>();
        for (String pathFile : pathFiles) {
            String jsonStr = readJsonFile(pathFile);
            JSONObject jsonObject = JSONObject.parseObject(jsonStr);
            String password = decodePass(jsonObject.getString("password"));
